...
For deterministic population quadrature, conservative mass transport, and the
synthetic calibration pilot, see [CONTINUUM_CALIBRATION.md](CONTINUUM_CALIBRATION.md).
